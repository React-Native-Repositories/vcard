...
export default function Services() {
  ...
  const [list, setList] = useState([
    {
      service_image:
        'https://images.unsplash.com/photo-1626863905121-3b0c0ed7b94c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2970&q=80',
      service_name: 'Telecom Service',
      description: 'Telecom Service',
    },
    {
      service_image:
        'https://images.unsplash.com/photo-1604754742629-3e5728249d73?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80',
          ...
          <View style={styles.textContainer}>
            <View style={styles.imageView}>
              ...
              <View style={styles.imageLeft}>
                <Image
                  source={{uri: getValue(item, `service_image`, '')}}
                  style={{height: hp(80), width: wp(160), marginTop: hp(20)}}
                  resizeMode="contain"
                />
              </View>
              <View style={styles.imageRight}>
                <AppText>{item.service_name}</AppText>
                <AppText
                  style={[
                    styles.text,
